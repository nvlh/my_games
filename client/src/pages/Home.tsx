...
export default function Home() {
  ...
  const createGame = trpc.publicGames.create.useMutation({ onSuccess: () => { setGameUploadError(""); setManagerOpen(false); setEditingGameId(undefined); setRomFile(undefined); setCoverFile(undefined); setIconFile(undefined); setScreenshotFile(undefined); setGameForm({ name: "", slug: "", platform: "nes", genre: "action", description: "", players: "单人", input: "键盘/手柄" }); void trpcUtils.publicGames.list.invalidate(); }, onError: (error) => setGameUploadError(error.message) });
